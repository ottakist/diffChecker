...
function App() {
  ...
  return (
    <main className='flex h-screen'>
      <div className='w-1/2 h-1/2 mx-5 my-5 border-solid border-2 bg-gray-300 border-gray-500 shadow-md rounded-lg  overflow-hidden flex flex-col'>
      ...
      <div className='w-1/2 h-1/2 mx-5 my-5 border-solid border-2 bg-gray-300 border-gray-500 shadow-md rounded-lg overflow-hidden flex flex-col'>
        ...
        <textarea
          className='flex-grow mx-6 resize-none text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400'
          placeholder=' '
          value={editedText}
